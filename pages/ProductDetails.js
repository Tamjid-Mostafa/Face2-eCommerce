            ...
            <div className='grid grid-cols-1 lg:grid-cols-2'>
                ...
                <div className='my-10 -ml-12 bg-gray-200 p-6 text-black'>
                    ...
                    <div className="flex gap-3">
                        <button className="px-5 py-2 border-2 border-primary" type='submit'>L</button>
                        <button className="px-5 py-2 border-2 border-primary" type='submit'>M</button>
                        <button className="px-5 py-2 border-2 border-primary" type='submit'>XL</button>
                        <button className="px-5 py-2 border-2 border-primary" type='submit'>XXL</button>
                    </div>
