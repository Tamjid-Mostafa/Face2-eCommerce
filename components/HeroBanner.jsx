            ...
            <div
                ...
                <div className="md:w-[70%] mx-auto pt-32 ">
                    ...
                    <div className="flex justify-center absolute bottom-[15%] left-[25%] lg:left-[45%]">
                        <Link href="" className='px-5 py-3 bg-cyan-400 rounded-3xl flex items-center justify-center w-44'>Get Started <RxPinRight className='ml-2 text-2xl'></RxPinRight></Link>
                    </div>
                </div>
            </div>
